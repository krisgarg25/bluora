        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-black p-4">
            <div className="w-full max-w-md p-8 space-y-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.3)]">
                <div className="text-center">
                    ...
                    <p className="text-cyan-100/60 text-sm mt-2">Join us for premium hydration</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-cyan-100/80 mb-2">Name</label>
                        <input
                            type="text"
                            name="name"
                            required
                ...
                <div className="text-center text-sm text-cyan-100/60">
                    Already have an account? <Link href="/auth/login" className="text-cyan-400 hover:text-cyan-300 font-semibold hover:underline">Log in</Link>
                </div>
            </div>
        </div>
    );
